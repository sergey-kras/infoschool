...
},{"../api/instance":1}],3:[function(require,module,exports){
function menu($) {
    let opened = false;
...
var $ = require('jquery');
var menu = require('./components/adaptive-menu'); 
var aboutPopup = require('./components/about-popup'); 
var showMore = require('./components/case-show-more'); 

menu($);
aboutPopup($);
showMore($);

},{"./components/about-popup":2,"./components/adaptive-menu":3,"./components/case-show-more":4,"jquery":32}],6:[function(require,module,exports){
...
},{"../core/createError":14,"./../core/settle":17,"./../helpers/btoa":21,"./../helpers/buildURL":22,"./../helpers/cookies":24,"./../helpers/isURLSameOrigin":26,"./../helpers/parseHeaders":28,"./../utils":30,"rH1JPG":33}],8:[function(require,module,exports){
'use strict';
...
},{"./adapters/http":7,"./adapters/xhr":7,"./helpers/normalizeHeaderName":27,"./utils":30,"rH1JPG":33}],20:[function(require,module,exports){
'use strict';
